...
class AISA_Tools {
			...
			array(
				...
				'input_schema' => array(
					...
					'properties' => array(
						...
						'post_type' => array( 'type' => 'string', 'description' => 'post, page, or any registered type.' ),
			...
			array(
				...
				'input_schema' => array(
					...
					'properties' => array(
						...
						'content'   => array( 'type' => 'string', 'description' => 'HTML or block markup.' ),
	...
	private static function error( $message ) {
		return array( 'content' => $message, 'is_error' => true );
	}
