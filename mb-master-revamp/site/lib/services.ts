...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    cluster: "Lead generation",
    angle: "Buying the clicks search has not earned yet",
  ...
  },
  {
    ...
    name: "French SEO",
    cluster: "Search",
    angle: "Where the francophone volume actually sits",
  ...
  },
  {
    ...
    name: "German SEO",
    cluster: "Search",
    angle: "Researched longer, decided slower",
  ...
  },
  {
    ...
    name: "Spanish SEO",
    cluster: "Search",
    angle: "Researched from here, not from abroad",
  ...
  },
  {
    ...
    name: "Italian SEO",
    cluster: "Search",
    angle: "Where translated copy gets found out",
  ...
  // ---- Cluster 4: AI, the differentiator ----
  {
    ...
    cluster: "AI",
    pillar: true,
    angle: "Where AI helps, and where it quietly does not",
  ...
  // ---- Cluster 5: supporting capability ----
  {
    ...
    name: "Technical SEO",
    cluster: "Supporting",
    angle: "The plumbing nobody notices until it breaks",
