...
export const BLOG_IMAGES: Record<string, BlogImage> = {
  ...
  "multilingual-keyword-research": { width: 1200, height: 630, alt: "Small fishing boats spread across a calm bay at dawn, casting nets over different shoals", legacy: "owner:blog-illustrator/multilingual-keyword-research.png", credit: { author: "Generated by the owner with BlogIllustrator AI", source: "Owner", sourceUrl: "", licence: "Owner-generated, no attribution required" } },
  ...
  "top-instagram-tools": { width: 1200, height: 630, alt: "A photographer's kit on a wooden table: a camera, lenses, a ring light and a phone gimbal", legacy: "owner:blog-illustrator/top-instagram-tools.png", credit: { author: "Generated by the owner with BlogIllustrator AI", source: "Owner", sourceUrl: "", licence: "Owner-generated, no attribution required" } },
