...
Mon rôle n’est pas d’exécuter une commande de traduction. C’est d’arbitrer en amont : priorisation marchés, architecture cible, allocation de budget par pays, séquencement des lancements. Le [SEO multilingue](https://mikebastin.com/fr/nos-services/referencement-multilingue/) et la [présence locale par pays](https://mikebastin.com/fr/nos-services/referencement-local/) sont les chantiers d’exécution qui suivent.
...
**Livrable :** coordination de l’exécution avec vos équipes ou prestataires ([SEO multilingue](https://mikebastin.com/fr/nos-services/referencement-multilingue/), [SEO local par pays](https://mikebastin.com/fr/nos-services/referencement-local/), traduction, dev). Comités mensuels, arbitrages stratégiques, ajustements roadmap.
