...
**Deliverable:** campaign architecture per market (Search, Display, Performance Max as relevant), budget split, bidding strategy, ad copy briefs, landing page plan, conversion tracking spec, monthly KPI targets.

**Deliverable:** campaigns built per market with native ad copy, conversion tracking validated end to end (GA4 + GTM + CRM where applicable), landing pages aligned, dry-run audit before activation. Soft launch with conservative budget for the first 2 weeks.

**Deliverable:** weekly checkpoints during the first month, monthly reporting thereafter. KPIs: CPL per market, ROAS per market, qualified pipeline per market, share of voice on key terms. Decision points to scale, hold or kill per market based on hard data.
...
**Context:** translation agency running Google Ads across multiple European country domains. Each market has its own primary language, commercial conventions and competition space.
...
⨯ via partner production studios on quote
...
Quoted. Management fee depends on number of markets, platforms, complexity. Ad spend depends on competitive space and growth targets. Free first call: 30 minutes to understand your context and give honest ranges for both. No generic proposal sent without a conversation.
